...
public class Instrument {
    ...
    private static void instrumentMyServerSocket() throws NotFoundException, IOException, CannotCompileException {
        ClassPool classPool = ClassPool.getDefault();
        CtClass myServerSocket = classPool.get("MyServerSocket");

        CtMethod sendMethod = myServerSocket.getDeclaredMethod("sendString");
        ...
        CtMethod receiveMethod = myServerSocket.getDeclaredMethod("receiveString");
