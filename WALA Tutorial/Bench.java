...
public class Bench {
    ...
    private static void doClass(final ClassInstrumenter ci, Writer w) throws IOException, InvalidClassFileException, Analyzer.FailureException {
        ...
        for (int m = 0; m < ci.getReader().getMethodCount(); m++) {
            ...
            // d could be null, if the method is abstract or native
            if (d != null) {
                w.write(
                        "Instrumenting "
    ...
    public static void main(String[] args) throws IOException {
        for (int i = 0; i < 1; i++) {
            ...
            } catch (IOException | InvalidClassFileException | Analyzer.FailureException e) {
                e.printStackTrace();
            }
            instrumenter.close();
        }
